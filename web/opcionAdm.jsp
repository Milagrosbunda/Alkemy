      ...
      <div class="row tm-welcome-row">
        <div class="col-12 tm-page-cols-container">
          <div class="tm-page-col-left tm-welcome-box tm-bg-primary">
                <a class="btn btn-secondary tm-btn-submit rounded-0" href="GestionProf.jsp">Gestion de Profesores</a>
                <a class="btn btn-secondary tm-btn-submit rounded-0" href="NewMateria.jsp">Nueva Materia </a>
          </div>
          <div class="tm-page-col-right">
            <div
              class="tm-welcome-parallax"
              data-parallax="scroll"
              data-image-src="universidad.jpg"
            ></div>
          </div>
        </div>
      </div>
